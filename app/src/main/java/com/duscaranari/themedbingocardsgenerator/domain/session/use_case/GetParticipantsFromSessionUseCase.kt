...
class GetParticipantsFromSessionUseCase @Inject constructor(private val sessionRepository: SessionRepository) {

    operator fun invoke(sessionId: String) =
        sessionRepository.getParticipantsFromSessionId(sessionId)
}